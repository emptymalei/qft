# -*- coding: utf-8 -*-
#
# QFT documentation build configuration file, created by
...
project = u'Quantum Field Theory'
...
latex_documents = [
  ('index', 'qft.tex', u'Quantum Field Theory Notes',
   u'Lei Ma', 'manual'),
]
...
man_pages = [
    ('index', 'qft', u'Quantum Field Theory Notes',
     [u'Lei Ma'], 1)
]
...
texinfo_documents = [
  ('index', 'qft', u'Quantum Field Theory Notes',
   u'Lei Ma', 'QFT', 'Quantum Field Theory Notes',
   'Miscellaneous'),
]
...
epub_title = u'Quantum Field Theory Notes'
